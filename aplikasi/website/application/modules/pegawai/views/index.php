									...
									<tr>
										...
										<td>
											<div class="media-body">
												<a href="<?php echo base_url('pegawai/pasien/show_history/'.$p['id_pasien'])?>" class="display-inline-block text-semibold letter-icon-title">[#<?php echo $p['nomor_pendaftaran']?>] <?php echo $p['nama_pasien']?></a>
