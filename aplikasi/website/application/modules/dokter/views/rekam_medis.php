														...
														<div class="panel-footer panel-footer-transparent"><a class="heading-elements-toggle"><i class="icon-more"></i></a>
															<div class="heading-elements">
																<span class="heading-btn pull-right">
																	<a href="<?php echo base_url('dokter/pasien/show_history_detail/'.$h['id_pasien'].'/'.$h['id_rekam_medis'].'/'.$h['id_pendaftaran'])?>" class="btn btn-link">Lihat detail <i class="icon-arrow-right14 position-right"></i></a>
																</span>
															</div>
														</div>
													</div>
