		...
		<div class="panel panel-flat">
			...
			<table class="table datatable-basic">
				...
				<tbody>
					...
					<tr>
						<td><a href="<?php echo base_url('dokter/pasien/show_history/'.$p['id_pasien'])?>">
								...
								<ul class="icons-list">
									<li class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-right">
											...
											<li><a href="<?php echo base_url('dokter/pasien/show_history/'.$p['id_pasien'])?>"><i class="icon-history"></i> Lihat Riwayat</a></li>
										</ul>
									</li>
								</ul>
							<?php } else {?>
