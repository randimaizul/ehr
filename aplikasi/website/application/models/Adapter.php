            ...
            if($table == "pasien"){
                ...
                if($data['obj']->num_rows() > 0 ){
                    foreach ($data['obj']->result() as $key => $value) {
                        ...
                        $pendaftaran[$key]['id_rekam_medis'] = $value->id_rekam_medis;
                        ...
                        $pendaftaran[$key]['keluhan_utama'] = $value->keluhan_utama;
                        $pendaftaran[$key]['riwayat_alergi'] = $value->riwayat_alergi;
                        $pendaftaran[$key]['tanda_vital'] = $value->tanda_vital;
                    }
