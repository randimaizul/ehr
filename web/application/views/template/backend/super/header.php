...
<head>
	...
	<title>Superadmin Labsatu</title>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>data/assets/css/sweetalert2.min.css" />
	<!-- /core JS files -->
	...
	<!-- /theme JS files -->
	<script type="text/javascript" src="<?php echo base_url(); ?>data/assets/js/sweetalert2.min.js"></script>
	<!-- text editor  -->
